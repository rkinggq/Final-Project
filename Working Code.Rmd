...
### Spatial Autocorrelation of Amphibian Mortality 
...
To assess trends in amphibian mortality rates from road crossings across multiple years, we plotted the mortality rates (calculated as the ratio of dead to crossed amphibians) for different species over time. This analysis helps to identify any temporal changes in mortality rates, which could be indicative of the impact of increasing urbanization on amphibian populations.
...
### Assessing the Role of Land-Use Patterns in Predicting Amphibian Crossing Mortality 


To explore the influence of urbanization (represented by the development index), year, species, and town on amphibian road crossings, we built a random forest model. The model uses the development index (dev_index), year, town (TOWN), and species as predictors for the number of road crossings (Crossed). The importance of each predictor is assessed to understand which factors most influence amphibian mortality across different towns.
