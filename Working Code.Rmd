...
```{r, data}
f <- list.files("/Users/carolinevontzalides/Documents/Org Bio Github/Final_Project/NLCD",pattern = ".tif")
print(f)
...
#towns: 
nh <- read_sf("/Users/carolinevontzalides/Documents/Org Bio Github/Final_Project/NH/New_Hampshire_Political_Boundaries.shp") %>%
  rename(TOWN=pbpNAME) 
